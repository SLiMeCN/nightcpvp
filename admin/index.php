							...
							<div class="col-xl-8">
								<div class="card">
									<div class="card-body" style="height: 507px;">
										...
										<?php 
											$sql = "SELECT {$DP}user_log.*,u.pic,u.email,u.user,u.name from {$DP}user_log LEFT JOIN `{$DP}user` as u ON ({$DP}user_log.uid=u.id) ORDER BY id desc limit 0,5";
													...
													<tr>
														<td class="media">
															...
															<div class="media-body">
																<a href="user_edit.php?id=<?php echo $rows['uid']; ?>" class="text-title"><h5 class="mt-0 mb-1 line-limit-length" style="width:150px!important"><?php echo (empty($rows['user'])) ? $rows['email'] : $rows['user'];?></h5></a>
																<span class="font-13"><?php echo $rows['name'];?></span>
															</div>
                                                        </td>
														<td>
															<h5 class="font-14 mb-1 font-weight-normal line-limit-length" style="width:80px!important"><?php echo $lang_user[$rows['type']]; ?></h5>
														...
														<td>
															<h5 class="font-14 mb-1 font-weight-normal line-limit-length" style="width:80px!important"><?php if($rows['fen'] >0){echo '+'.$rows['fen'];}else{echo $rows['fen'];} ?></h5>
															<span class="text-muted font-13">积分变化</span>                                                        
														</td>
														<td>
															<h5 class="font-14 mb-1 font-weight-normal line-limit-length" style="width:80px!important"><?php if($rows['vip'] >0){echo '+'.$rows['vip'];}else{echo $rows['vip'];} ?></h5>
